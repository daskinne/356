...
public class ZJdbcVisitRepositoryImpl implements VisitRepository {
    ...
    @Override
    public void save(VisitOld visit) throws DataAccessException {
        if (visit.isNew()) {
    ...
    /**
     * Creates a {@link MapSqlParameterSource} based on data values from the supplied {@link VisitOld} instance.
     */
    private MapSqlParameterSource createVisitParameterSource(VisitOld visit) {
    ...
    public List<VisitOld> findByPetId(Integer petId) {
        final List<VisitOld> visits = this.jdbcTemplate.query(
                "SELECT id, visit_date, description FROM visits WHERE pet_id=?",
                new ParameterizedRowMapper<VisitOld>() {
                    @Override
                    public VisitOld mapRow(ResultSet rs, int row) throws SQLException {
